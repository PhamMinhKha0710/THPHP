...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h1 class="h3 mb-1 text-primary">Danh sách sản phẩm</h1>
    ...
    <div class="card mb-4 border-0">
        <div class="card-body p-4">
            <form action="/THPHP/WebBanHangtuan2/Product/list" method="GET" class="row g-3">
                <div class="col-md-4">
                    <label class="form-label small text-muted mb-2">Tìm kiếm</label>
                    <input type="text" name="search" class="form-control" placeholder="Nhập tên sản phẩm..." value="<?php echo isset($_GET['search']) ? htmlspecialchars($_GET['search']) : ''; ?>">
                </div>
                <div class="col-md-3">
                    <label class="form-label small text-muted mb-2">Danh mục</label>
                ...
                <div class="col-md-3">
                    <label class="form-label small text-muted mb-2">Sắp xếp</label>
                    ...
                    <div class="card h-100 product-card">
                        <div class="product-img-container position-relative">
                            ...
                            <?php else: ?>
                                <img src="/THPHP/WebBanHangtuan2/uploads/default-product.png" 
                                     ...
                                     class="card-img-top product-image">
                            <?php endif; ?>
                            <span class="category-badge position-absolute top-0 end-0 m-2">
                        ...
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <div class="d-flex gap-2 align-items-center">
                                ...
                                <form action="/THPHP/WebBanHangtuan2/Product/addToCart" method="POST" class="flex-grow-1">
