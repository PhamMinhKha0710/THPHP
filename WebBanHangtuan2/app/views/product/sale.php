...
<div class="container py-4">
    <div class="row mb-4">
        <div class="col-12">
            <h1 class="h2 mb-0">Khuyến Mãi</h1>
            <p class="text-muted mb-0">Sản phẩm đang giảm giá - Cơ hội mua sắm với giá tốt nhất</p>
        </div>
    </div>

    <?php if (empty($products)): ?>
    <div class="alert alert-info">
        <i class="fas fa-info-circle me-2"></i> Hiện chưa có sản phẩm khuyến mãi nào.
    </div>
    <?php else: ?>
    <div class="row g-4">
            ...
            <div class="product-card position-relative h-100">
                ...
                <div class="product-info">
                    ...
                    <div class="product-price">
                        <span class="fw-bold text-danger"><?php echo number_format($product->price * 0.9, 0, ',', '.'); ?>đ</span>
                        <small class="text-muted text-decoration-line-through"><?php echo number_format($product->price, 0, ',', '.'); ?>đ</small>
                    </div>
                </div>
            </div>
        </div>
